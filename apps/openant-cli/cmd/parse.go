...
Supports Python, JavaScript/TypeScript, Go, C/C++, Java, Ruby, and PHP repositories.
...
func init() {
	...
	parseCmd.Flags().StringVarP(&parseLanguage, "language", "l", "", "Language: python, javascript, go, c, java, ruby, php, cicd, auto")
